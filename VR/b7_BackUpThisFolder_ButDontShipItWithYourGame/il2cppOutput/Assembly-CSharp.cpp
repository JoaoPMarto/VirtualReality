...
{
	// UnityEngine.AudioClip PlayAudioOnTriggerEnter::clip
	AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* ___clip_4;
	// UnityEngine.AudioSource PlayAudioOnTriggerEnter::source
	AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* ___source_5;
	// System.String PlayAudioOnTriggerEnter::targetTag
	String_t* ___targetTag_6;
	// System.Boolean PlayAudioOnTriggerEnter::useVelocity
	bool ___useVelocity_7;
	// System.Single PlayAudioOnTriggerEnter::minVelocity
	float ___minVelocity_8;
	// System.Single PlayAudioOnTriggerEnter::maxVelocity
	float ___maxVelocity_9;
	// System.Boolean PlayAudioOnTriggerEnter::randomizePitch
	bool ___randomizePitch_10;
	// System.Single PlayAudioOnTriggerEnter::minPitch
	float ___minPitch_11;
	// System.Single PlayAudioOnTriggerEnter::maxPitch
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void PlayAudioOnTriggerEnter::Start()
...
// System.Void PlayAudioOnTriggerEnter::OnTriggerEnter(UnityEngine.Collider)
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayAudioOnTriggerEnter_OnTriggerEnter_mA1F88F2DDC436CF9D33155FF9DC6A181B445E143 (PlayAudioOnTriggerEnter_tA1090A8A54065910732D07870E0BC99AAE0DB4E1* __this, Collider_t1CC3163924FCD6C4CC2E816373A929C1E3D55E76* ___other0, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
	...
	memset((&V_3), 0, sizeof(V_3));
	{
		...
		String_t* L_1 = __this->___targetTag_6;
		NullCheck(L_0);
		bool L_2;
	...
	}
	{
		...
		L_4 = Component_GetComponent_TisVelocityEstimator_tD78416F4108F4B6ACD65DA7A3C561A46D195BF49_mC6973BF06B42E54D07BA9D9A8D4E47C8D3D11452(L_3, Component_GetComponent_TisVelocityEstimator_tD78416F4108F4B6ACD65DA7A3C561A46D195BF49_mC6973BF06B42E54D07BA9D9A8D4E47C8D3D11452_RuntimeMethod_var);
		V_0 = L_4;
		// if(estimator && useVelocity){
		VelocityEstimator_tD78416F4108F4B6ACD65DA7A3C561A46D195BF49* L_5 = V_0;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_6;
	...
	{
		bool L_7 = __this->___useVelocity_7;
		if (!L_7)
		{
			goto IL_0081;
		}
	}
	{
		...
		VelocityEstimator_tD78416F4108F4B6ACD65DA7A3C561A46D195BF49* L_8 = V_0;
		NullCheck(L_8);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_9;
		L_9 = VelocityEstimator_GetVelocityEstimate_mAEE5A770A4234416406372E1087780B116F215D3(L_8, NULL);
		V_3 = L_9;
		float L_10;
		...
		float L_11 = __this->___minVelocity_8;
		float L_12 = __this->___maxVelocity_9;
		float L_13 = V_1;
		float L_14;
		L_14 = Mathf_InverseLerp_mBD7EC6A7173CE082226077E1557D5BC2D2AE0D9D_inline(L_11, L_12, L_13, NULL);
		V_2 = L_14;
		// if(randomizePitch){
		bool L_15 = __this->___randomizePitch_10;
		if (!L_15)
		{
			goto IL_006e;
		}
	}
	{
		...
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_16 = __this->___source_5;
		float L_17 = __this->___minPitch_11;
		float L_18 = __this->___maxPitch_12;
		float L_19;
		L_19 = Random_Range_m5236C99A7D8AE6AC9190592DC66016652A2D2494(L_17, L_18, NULL);
		NullCheck(L_16);
		AudioSource_set_pitch_mD14631FC99BF38AAFB356D9C45546BC16CF9E811(L_16, L_19, NULL);
	}

IL_006e:
	{
		// source.PlayOneShot(clip, volume);
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_20 = __this->___source_5;
		AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* L_21 = __this->___clip_4;
		float L_22 = V_2;
		NullCheck(L_20);
...
IL_0081:
	{
		// if(randomizePitch){
		bool L_23 = __this->___randomizePitch_10;
		if (!L_23)
		{
			goto IL_00a5;
		}
	...
	{
		// source.pitch = Random.Range(minPitch, maxPitch);
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_24 = __this->___source_5;
		float L_25 = __this->___minPitch_11;
		float L_26 = __this->___maxPitch_12;
		float L_27;
		L_27 = Random_Range_m5236C99A7D8AE6AC9190592DC66016652A2D2494(L_25, L_26, NULL);
		NullCheck(L_24);
		AudioSource_set_pitch_mD14631FC99BF38AAFB356D9C45546BC16CF9E811(L_24, L_27, NULL);
	}

IL_00a5:
	{
		// source.PlayOneShot(clip);
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_28 = __this->___source_5;
		AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* L_29 = __this->___clip_4;
		NullCheck(L_28);
...
// System.Void PlayAudioOnTriggerEnter::.ctor()
